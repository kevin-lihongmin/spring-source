...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 *  该类的实例化需要依赖其他先初始化的Bean， 对应depends-on属性，如：
	 *  <bean id="springUtils" class="com.jd.o2o.pms.common.utils.SpringUtils" depends-on=""/>
	 */
	@Nullable
	...
	/**
	 *  是否允许访问非public的属性或非法，默认是true，反射
	 */
	...
	/**
	 *  记录解析的constructor-org
	 */
	@Nullable
	private ConstructorArgumentValues constructorArgumentValues;

	/**
	 *  记录解析的解析的普通的属性集合 List<PropertyValue>
	 */
	@Nullable
	private MutablePropertyValues propertyValues;

	/**
	 *  保存方法重新的记录 lookup-method， replaced-method
	 */
	@Nullable
	...
	/**
	 *  合成的意思，是否为用户定义还是程序本身（就是有么有被重新），创建AOP的时候为true
	 */
