...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	...
	protected View loadView(String viewName, Locale locale) throws Exception {
		// 创建一个基本的view，（即非forward和Redirect）
	...
	protected AbstractUrlBasedView buildView(String viewName) throws Exception {
		// 根据一个String的view，想要创建一个view对象，先反射，再设置属性，Spring做了很多事情，就为了方便我们
		// 总之就是填充各种属性
		Class<?> viewClass = getViewClass();
		Assert.state(viewClass != null, "No view class");

		// 使用反射根据Class创建AbstractUrlBasedView， 再设置url 前缀 + viewName + 后缀
	...
	protected View applyLifecycleMethods(String viewName, AbstractUrlBasedView view) {
		...
		if (context != null) {
			// 根据applicationContext获取BeanFactory， 在去初始化Bean
			// 就是讲ioc容器中的名称为viewName的Bean，替换为该对象
